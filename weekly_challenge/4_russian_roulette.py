...
ascii_label = tk.Label(root, text=ascii_art, bg="#2b2b2b", fg="#ff5555", font=("Courier", 12))
...
button = tk.Button(root, text="Pull the trigger", command=on_button_click, bg="#555555", fg="#ffffff", font=("Helvetica", 12))
button.pack(pady=10)
